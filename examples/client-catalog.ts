...
async function main() {
  ...
  try {
    ...
    const scalarFuncs = await client.schemaContentsFunctions(attachOpaqueData, "main", "SCALAR_FUNCTION");
    ...
    const tableFuncs = await client.schemaContentsFunctions(attachOpaqueData, "main", "TABLE_FUNCTION");
